...
import { OpenAiPixel } from "@/app/components/openai-pixel";
...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="pt-BR"><body>{children}<MetaPixel /><OpenAiPixel /></body></html>}
